...
const CropCard = memo(function CropCard({ crop, onDelete, onUpdate }) {
  ...
  const handleSave = async (e) => {
    ...
    if (onUpdate) {
      await onUpdate(crop.id, { name: editName.trim(), season: editSeason, water: editWater });
    }
    setIsEditing(false);
  };
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        title="Confirm Crop Removal"
        message={`Are you sure you want to remove ${crop.name} from the registered crop catalog?`}
